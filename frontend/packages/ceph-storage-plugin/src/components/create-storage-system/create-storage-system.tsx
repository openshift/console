...
import { StepsId } from '../../constants/create-storage-system';
import { StorageSystemKind } from '../../types';
import { StorageSystemModel } from '../../models';
import { StorageClusterIdentifier } from '../../odf-external-providers/external-providers';
...
const CreateStorageSystem: React.FC<CreateStorageSystemProps> = ({ match }) => {
  ...
  return (
    <>
      <CreateStorageSystemHeader t={t} url={url} />
      <Wizard
        steps={steps}
        footer={
