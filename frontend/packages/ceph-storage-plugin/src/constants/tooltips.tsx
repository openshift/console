...
export const attachDevices = (t: TFunction, scName: string) => {
  return (
    <Trans t={t} ns="ceph-storage-plugin">
      Selected nodes are based on the storage class <em>{{ scName }}</em> and with a recommended
...
export const attachDevicesWithArbiter = (t: TFunction, scName: string) => {
  return (
    <Trans t={t} ns="ceph-storage-plugin">
      Selected nodes are based on the storage class <em>{{ scName }}</em> and fulfill the stretch
