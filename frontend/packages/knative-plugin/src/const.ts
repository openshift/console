...
const KNATIVE_AUTOSCALING_APIGROUP = 'autoscaling.knative.dev';
...
export const EVENT_TYPE_NAME_PARAM = 'eventTypeName';
export const EVENT_TYPE_NAMESPACE_PARAM = 'eventTypeNamespace';
export const SUBSCRIBE_PROVIDER_API_VERSION_PARAM = 'providerApiVersion';
export const SUBSCRIBE_PROVIDER_KIND_PARAM = 'providerKind';
export const SUBSCRIBE_PROVIDER_NAME_PARAM = 'providerName';
...
export const FUNCTIONS_GETTING_STARTED_SECTION_USER_PREFERENCE_KEY =
  'functions.gettingStartedSection';
