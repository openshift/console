export const eventingPO = {
  createEventDropDownMenu: '[data-test="console-select-menu-toggle"]',
  ...
  pingSource: {
    ...
    resourceItem: '[data-test="console-select-item"]',
    submit: '[data-test-id="submit-button"]',
  ...
  channel: {
    ...
    dropDownMenu: '[data-test-id="console-select-item"]',
    ...
    applicationItem: '[data-test=console-select-item]',
    ...
    typeFieldMenu: '[data-test-id="console-select-item"]',
  ...
  broker: {
    ...
    sidebar: {
      ...
      subscriberFilter: '[data-test="console-select-search-input"]',
      subscriberItem: '[data-test="console-select-item"]',
    },
    applicationGrouping: {
      ...
      menu: '[class="pf-v6-c-dropdown__menu-item"]',
  ...
  filter: {
    ...
    TypeMenu: '[data-test="console-select-menu-toggle"]',
    Type: '[data-test-id="console-select-item"]',
    count: '.pf-v6-c-badge',
  ...
  kafka: {
    ...
    dropdownList: '[data-test="console-select-menu-list"]',
    dropdownOptions: '[data-test="console-select-item"]',
  ...
  kafkaSource: {
    ...
    toggleText: '[class="pf-v6-c-dropdown__toggle-text"]',
    dropdownInput: '[data-test="console-select-search-input"]',
