export const eventingPO = {
  ...
  channel: {
    ...
    channelDropdown: '.pf-v5-c-dropdown__menu-item',
    ...
    labelTagsInput: '.tags',
    sidebarLabelList: '.pf-v5-c-label-group__main',
    ...
    contextMenuItem: '.pf-v5-c-dropdown__menu-item',
  ...
  pageDetails: '.pf-v5-c-breadcrumb',
...
export const domainPO = {
  ...
  chipText: '[class="pf-v5-c-chip__text"]',
};
