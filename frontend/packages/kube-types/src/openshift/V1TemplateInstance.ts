...
import { V1TemplateInstanceSpec } from './V1TemplateInstanceSpec';
 ...
 * @export
 * @interface V1TemplateInstance
 */
export interface V1TemplateInstance {
  /**
   * APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#resources
   * @type {string}
   * @memberof V1TemplateInstance
   */
  apiVersion?: string;
  /**
   ...
   * @memberof V1TemplateInstance
   */
  spec: V1TemplateInstanceSpec;
  /**
   *
   * @type {V1TemplateInstanceStatus}
   * @memberof V1TemplateInstance
   */
  status: V1TemplateInstanceStatus;
}
