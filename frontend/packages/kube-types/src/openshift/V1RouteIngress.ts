...
import { V1RouteIngressCondition } from './V1RouteIngressCondition';

/**
 * RouteIngress holds information about the places where a route is exposed.
 * @export
 * @interface V1RouteIngress
 */
export interface V1RouteIngress {
  /**
   * Conditions is the state of the route, may be empty.
   * @type {Array<V1RouteIngressCondition>}
   * @memberof V1RouteIngress
   */
  conditions?: V1RouteIngressCondition[];
  /**
