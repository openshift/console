 ...
 * @export
 * @interface OSV1PodSecurityPolicySubjectReviewStatus
 */
export interface OSV1PodSecurityPolicySubjectReviewStatus {
  /**
   *
   * @type {V1ObjectReference}
   * @memberof OSV1PodSecurityPolicySubjectReviewStatus
   */
