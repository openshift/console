...
import { OSV1BuildConfigSpec } from './OSV1BuildConfigSpec';
import { OSV1BuildConfigStatus } from './OSV1BuildConfigStatus';
 ...
 * @export
 * @interface OSV1BuildConfig
 */
export interface OSV1BuildConfig {
  /**
   * APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#resources
   * @type {string}
   * @memberof OSV1BuildConfig
   */
  apiVersion?: string;
  /**
  ...
  /**
   *
   * @type {OSV1BuildConfigSpec}
   * @memberof OSV1BuildConfig
   */
  spec: OSV1BuildConfigSpec;
  /**
   *
   * @type {OSV1BuildConfigStatus}
   * @memberof OSV1BuildConfig
   */
  status: OSV1BuildConfigStatus;
}
