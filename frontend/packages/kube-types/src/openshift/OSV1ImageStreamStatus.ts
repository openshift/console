...
import { OSV1NamedTagEventList } from './OSV1NamedTagEventList';

/**
 * ImageStreamStatus contains information about the state of this image stream.
 * @export
 * @interface OSV1ImageStreamStatus
 */
export interface OSV1ImageStreamStatus {
  /**
   ...
   * @type {string}
   * @memberof OSV1ImageStreamStatus
   */
   ...
   * @type {Array<OSV1NamedTagEventList>}
   * @memberof OSV1ImageStreamStatus
   */
  tags?: OSV1NamedTagEventList[];
}
