...
import { OSV1BuildStatusOutput } from './OSV1BuildStatusOutput';
import { OSV1StageInfo } from './OSV1StageInfo';
import { V1ObjectReference } from './V1ObjectReference';

/**
 * BuildStatus contains the status of a build
 * @export
 * @interface OSV1BuildStatus
 */
export interface OSV1BuildStatus {
  /**
  ...
  /**
   *
   * @type {OSV1BuildStatusOutput}
   * @memberof OSV1BuildStatus
   */
  output?: OSV1BuildStatusOutput;
  /**
   ...
   * @type {Array<OSV1StageInfo>}
   * @memberof OSV1BuildStatus
   */
  stages?: OSV1StageInfo[];
  /**
   *
   * @type {string}
   * @memberof OSV1BuildStatus
