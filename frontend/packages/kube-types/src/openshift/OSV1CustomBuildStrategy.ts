...
import { OSV1SecretSpec } from './OSV1SecretSpec';
 ...
 * @export
 * @interface OSV1CustomBuildStrategy
 */
export interface OSV1CustomBuildStrategy {
  /**
   * buildAPIVersion is the requested API version for the Build object serialized and passed to the custom builder
   * @type {string}
   * @memberof OSV1CustomBuildStrategy
   */
   ...
   * @type {Array<OSV1SecretSpec>}
   * @memberof OSV1CustomBuildStrategy
   */
  secrets?: OSV1SecretSpec[];
}
