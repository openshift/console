...
import { OSV1ImageLayer } from './OSV1ImageLayer';
import { OSV1ImageSignature } from './OSV1ImageSignature';
...
export interface OSV1Image {
   ...
   * @type {Array<OSV1ImageLayer>}
   * @memberof OSV1Image
   */
  dockerImageLayers: OSV1ImageLayer[];
  /**
   ...
   * @type {Array<OSV1ImageSignature>}
   * @memberof OSV1Image
   */
  signatures?: OSV1ImageSignature[];
}
