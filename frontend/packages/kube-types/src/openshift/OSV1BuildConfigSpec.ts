...
import { OSV1BuildTriggerPolicy } from './OSV1BuildTriggerPolicy';
 ...
 */
export interface OSV1BuildConfigSpec {
  /**
   ...
   * @type {Array<OSV1BuildTriggerPolicy>}
   * @memberof OSV1BuildConfigSpec
   */
  triggers: OSV1BuildTriggerPolicy[];
}
