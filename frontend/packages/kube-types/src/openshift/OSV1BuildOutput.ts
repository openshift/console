...
import { OSV1ImageLabel } from './OSV1ImageLabel';
 ...
 * @export
 * @interface OSV1BuildOutput
 */
export interface OSV1BuildOutput {
  /**
   ...
   * @type {Array<OSV1ImageLabel>}
   * @memberof OSV1BuildOutput
   */
  imageLabels?: OSV1ImageLabel[];
  /**
   *
