...
import { OSV1DeploymentStrategy } from './OSV1DeploymentStrategy';
import { OSV1DeploymentTriggerPolicy } from './OSV1DeploymentTriggerPolicy';
import { V1PodTemplateSpec } from './V1PodTemplateSpec';

/**
 * DeploymentConfigSpec represents the desired state of the deployment.
 * @export
 * @interface OSV1DeploymentConfigSpec
 */
export interface OSV1DeploymentConfigSpec {
  /**
   ...
   * @type {number}
   * @memberof OSV1DeploymentConfigSpec
   */
  ...
  /**
   *
   * @type {OSV1DeploymentStrategy}
   * @memberof OSV1DeploymentConfigSpec
   */
  strategy?: OSV1DeploymentStrategy;
  /**
   *
   ...
   * @type {Array<OSV1DeploymentTriggerPolicy>}
   * @memberof OSV1DeploymentConfigSpec
   */
  triggers?: OSV1DeploymentTriggerPolicy[];
}
