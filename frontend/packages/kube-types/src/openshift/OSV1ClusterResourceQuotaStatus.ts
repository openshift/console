...
import { OSV1ResourceQuotaStatusByNamespace } from './OSV1ResourceQuotaStatusByNamespace';
import { V1ResourceQuotaStatus } from './V1ResourceQuotaStatus';

/**
 * ClusterResourceQuotaStatus defines the actual enforced quota and its current usage
 * @export
 * @interface OSV1ClusterResourceQuotaStatus
 */
export interface OSV1ClusterResourceQuotaStatus {
  /**
   ...
   * @type {Array<OSV1ResourceQuotaStatusByNamespace>}
   * @memberof OSV1ClusterResourceQuotaStatus
   */
  namespaces: OSV1ResourceQuotaStatusByNamespace[];
  /**
   *
