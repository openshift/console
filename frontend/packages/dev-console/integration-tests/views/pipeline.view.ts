...
export const pipelineTableBody = element(by.className('ReactVirtualized__VirtualGrid__innerScrollContainer'));
...
export const pipelineScriptRunner = async function() {
    ...
    createPipelineYaml.click();
    browser.wait(until.presenceOf(saveChangesYamlPipeline));
    saveChangesYamlPipeline.click();
