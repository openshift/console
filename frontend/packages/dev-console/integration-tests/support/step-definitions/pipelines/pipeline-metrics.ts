...
import { pipelineDetailsText } from '@console/dev-console/integration-tests/support/constants';
import { pipelineDetailsPO } from '@console/dev-console/integration-tests/support/pageObjects';
