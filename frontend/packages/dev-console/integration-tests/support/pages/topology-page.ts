...
export const topologyPage = {
  ...
  clickContextMenuOption: (menuOption: string) =>
    cy
      .get('#popper-container li[role="menuitem"]')
      .contains(menuOption)
      .click(),
  ...
  selectContextMenuAction: (action: nodeActions | string) => topologyActions.selectAction(action),
};
...
export const topologySidePane = {
  ...
  verifyNumberOfAnnotations: (num: string) => {
    cy.get(topologyObj.sidePane.sectionTitle)
