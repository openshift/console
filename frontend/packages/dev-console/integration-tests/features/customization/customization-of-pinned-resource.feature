@customize-pre-pinned-resources
Feature: Customization of pre-pinned resources
        ...
        Background:
            Given user has created or selected namespace "aut-pinned-resources"

        @regression @manual
        Scenario: When pre-pinned resources customization is not added: DC-02-TC01
        ...
        @regression @manual
        Scenario: When resource is selected for pre-pinned navigation: DC-02-TC02
            Given user is at "operator.openshift.io/v1" console details page
              And user selects "Customize" in the Actions menu
              And user selects "Developer" tab in "Cluster configuration" page
        ...
        @regression @manual
        Scenario: When resource is removed from pre-pinned navigation: DC-02-TC03
            Given user is at "operator.openshift.io/v1" console details page
              And user selects "Customize" in the Actions menu
              And user selects "Developer" tab in "Cluster configuration" page
