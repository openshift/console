Feature: Helm Chart
    User should able to open the context menu and side bar for the helm releases
...
Scenario: Open Side Bar for the Helm release: HR-10-TC01
    ...
    Then user should see the sidebar for the helm release 


@regression, @smoke
Scenario: Tabs on the sidebar: HR-10-TC02
    Given user is on the sidebar for the helm release
    Then user should be able to see the Details tab
    And user should be able to see the Resources tab
    And user should be able to see the Release Notes tab
...
Scenario: Deployment Configs link on the sidebar for the Helm Release: HR-10-TC03
    ...
    Then user should be redirected to the Deployment Config Details page for the helm release
...
Scenario: Build Configs link on the sidebar for the Helm Release: HR-10-TC03
    ...
    Then user should be redirected to the Build Config Details page for the helm release
...
Scenario: Services link on the sidebar for the Helm Release: HR-10-TC03
    ...
    Then user should be redirected to the Service Details page for the helm release
...
Scenario: Image Streams link on the sidebar for the Helm Release: HR-10-TC03
    ...
    Then user should be redirected to the Image Stream Details page for the helm release
...
Scenario: Routes link on the sidebar for the Helm Release: HR-10-TC03
    ...
    Then user should be redirected to the Route Details page for the helm release
...
Scenario: Open Actions drop down menu on the side bar: HR-10-TC04
    ...
    Then user should be able to see the Upgrade action item
    And user should be able to see the Rollback action item
    And user should be able to see the Uninstall Helm Release action item
