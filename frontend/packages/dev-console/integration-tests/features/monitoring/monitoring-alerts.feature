...
Feature: Filter for Alert state and Severity
    ...
    @regression
    Scenario: Time range on Metrics in Alert details page
    ...
    @regression
    Scenario: Reset Zoom on Metrics in Alert details page
        Given user is on Alert details page
        When user selects "1 hour" on Time range dropdown
    ...
    @regression
    Scenario: Navigating to Metrics tab from Alert details page
        Given user is on Alert details page
    ...
    @regression
    Scenario: Alert Rule details page
        Given user is on Alerts tab
    ...
    @regression
    Scenario: Time range on Metrics in Alert rule details page
    ...
    @regression
    Scenario: Reset Zoom on Metrics in Alert rule details page
        Given user is on Alert rule details page
        When user selects "1 hour" on Time range dropdown
        And user clicks on Reset zoom
        Then user will see Time range changed to 30 minutes
    ...
    @regression
    Scenario: Navigating to Metrics tab from Alert rule details page
        Given user is on Alert rule details page
        When user clicks on View in Metrics
        Then user will be taken to Metrics tab in Monitoring
    ...
    @regression
    Scenario: Navigating to Alert details page from Alert rule details page
        Given user is on Alert rule details page
