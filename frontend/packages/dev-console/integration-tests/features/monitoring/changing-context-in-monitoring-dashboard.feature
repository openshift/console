...
Feature: Changing context in Monitoring Dashboard
    ...
    @regression
    Scenario: Charts display in monitoring dashboard for specific workload
    ...
    @regression
    Scenario: Charts display in monitoring dashboard for all workloads
    ...
    @regression
    Scenario: Restore the selected workload on refresh
        Given user is at the Monitoring dashboard
        When user clicks on filter dropdown
    ...
    @regression
    Scenario: Switiching to different project resests the workload
        Given user is at the Monitoring dashboard
        When user clicks on filter dropdown
        And user selects workload "nodejs-ex-git" from the workloads
