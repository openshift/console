Feature: Install the Helm Release
    ...
    Scenario: Install Helm Chart from Developer Catalog Page using YAML View: HR-03
        ...
        And user selects "Helm" option from Type section
        And user searches "Nodejs Ex K v0.2.1" from catalog page
        And user selects "Nodejs Ex K v0.2.1" card from catalog page
