@service-mesh @dev-console @broken-test
Feature: non-Admin user created Service Mesh Control Plane to get the Kiali dashboard link on the Topology filterbar
        ...
        @regression
        Scenario: Open on Kiali link Project Details Overview Page: SM-02-TC01
        ...
        @regression
        Scenario: Open on Kiali link Project Details Page: SM-02-TC02
            Given user is on the "istio-system" Projects page
        ...
        @regression
        Scenario: Kiali link in the Topology filterbar: SM-02-TC03
        ...
        @regression
        Scenario: Kiali link on the Kiali node in the Topology: SM-02-TC04
            Given user is at Developer perspective
              And user is on the "istio-system" Projects page
             When user clicks on the Topology page
              And user selects project that recently created Open Shift Service Mesh Control Plane
