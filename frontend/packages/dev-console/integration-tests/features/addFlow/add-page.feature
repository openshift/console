...
Feature: Add page on Developer Console
        ...
        @smoke
        Scenario: Options to create an Application, Component or Service
        ...
        @regression
        Scenario: Developer Catalog option to create an Application, Component or Service
        ...
        @regression
        Scenario: Git Repository option to create an Application, Component or Service
        ...
        @regression
        Scenario: From Local Machine option to create an Application, Component or Service
             Then user will see "Import YAML" option
              And user will see "Upload JAR file" option

        
        @regression
        Scenario: Details Toggle on
        ...
        @regression
        Scenario: Show Getting Started Resources
        ...
        @regression
        Scenario: Close Show Getting Started Resources link
            Given getting started resources is hidden from view
        ...
        @regression @manual
        Scenario: Getting Started Resources card when all Quick Starts have been completed
