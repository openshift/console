@guided-tour
Feature: Build your guided documentation card on cluster overview
        ...
        @regression @to-do
        Scenario: Build your guided documentation card on Cluster Overview: QS-04-TC01
        ...
        Scenario: Quick Starts links with status as in progress: QS-04-TC02
            Given user is at Cluster Overview page
             When user clicks on first Quick Starts link on the Build your guided documentation card
              ...
              And user clicks on Leave in Leave quick start modal box
             Then user can see the first Quick Start link present


        @regression @to-do
        Scenario: Build your guided documentation card when one Quick Start has completed: QS-04-TC03
            Given user is at Cluster Overview page
        ...
        @regression @to-do
        Scenario: Build your guided documentation card when all Quick Start has completed: QS-04-TC04
            Given user is at Cluster Overview page
             When user completes all the Quick Starts present
             Then user can see Build your guided documentation card is removed from the Cluster Overview page


        @regression @to-do
        Scenario: Remove Build your guided documentation card from Cluster Overview page: QS-04-TC05
            Given user is at Cluster Overview page
             When user clicks on the kebab menu at the Getting Started resources card
              And user clicks on Hide from the view
             Then Build your guided documentation card will be removed from Cluster Overview page


        @regression @to-do
        Scenario: Removed Build your guided documentation card from Cluster Overview page can be seen in Add page: QS-04-TC06
            Given user removed Build your guided documentation card from Cluster Overview page
             When user goes to developer perspective
              And user goes to Add page
             Then Build your guided documentation card will be displayed in Add page
