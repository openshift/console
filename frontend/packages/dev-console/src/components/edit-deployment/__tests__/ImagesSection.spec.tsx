...
test('ImagesSection: should have image-stream-tag dropdowns or image-name text field based on fromImageStreamTagCheckbox value', async () => {
...
test('ImagesSection: should have the required trigger checkbox fields based on fromImageStreamTagCheckbox value', async () => {
  const fromImageStreamTagCheckbox = screen.getByRole('checkbox', {
    name: /deploy image from an image stream tag/i,
  });
...
test('ImagesSection: should have the required trigger checkbox fields based on resourecType', async () => {
...
test('ImagesSection: should have the advanced options expand/collapse button', async () => {
