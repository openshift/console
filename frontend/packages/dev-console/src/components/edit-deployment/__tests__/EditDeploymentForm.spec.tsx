...
beforeEach(() =>
  render(
    <MockForm handleSubmit={handleSubmit} handleReset={handleReset}>
      {(props) => (
...
test('EditDeploymentForm: should show Form/YAML swicther with both options and Form view selected by default', async () => {
  await waitFor(() => {
...
test('EditDeploymentForm: should show all the form sections wrt form/YAML view', async () => {
...
test('EditDeploymentForm: should disable save button and show loader on save button click', async () => {
...
test('EditDeploymentForm: should load the form with current resource values on reload button click', async () => {
...
test('EditDeploymentForm: should call handleCancel on Cancel button click ', async () => {
