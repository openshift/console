...
const PipelineRunDecorator: React.FC<PipelineRunDecoratorProps & StateProps> = ({
  pipeline,
  pipelineRuns,
  radius,
  x,
...
// For testing
export const InternalPipelineRunDecorator = PipelineRunDecorator;

export default connect(impersonateStateToProps)(PipelineRunDecorator);
