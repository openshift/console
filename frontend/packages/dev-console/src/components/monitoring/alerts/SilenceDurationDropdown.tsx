...
const SilenceDurationDropDown: React.FC<SilenceDurationDropDownProps> = ({
  ...
  const setDuration = (duration: string) => {
    ...
    coFetchJSON
      .post(`${ALERT_MANAGER_TENANCY_BASE_PATH}/api/v2/silences?namespace=${namespace}`, payload)
      .then(() =>
        coFetchJSON(`${ALERT_MANAGER_TENANCY_BASE_PATH}/api/v2/silences?namespace=${namespace}`),
      )
