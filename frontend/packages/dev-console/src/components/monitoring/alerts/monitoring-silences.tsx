...
type MonitoringCreateSilencePageProps = {
  match?: RouteMatch<{ ns?: string }>;
};

export const MonitoringCreateSilencePage: React.FC<MonitoringCreateSilencePageProps> = ({
  match,
}) => {
  ...
  return (
    ...
    >
      <CreateSilence namespace={namespace} />
    </NamespacedPage>
  );
};
