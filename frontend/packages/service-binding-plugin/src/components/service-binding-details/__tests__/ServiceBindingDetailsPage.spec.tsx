...
jest.mock('@console/plugin-sdk', () => ({
  ...(jest as any).requireActual('@console/plugin-sdk'),
  useExtensions: () => [],
...
jest.mock('@console/shared/src/components/error/error-boundary', () => ({
  ...(jest as any).requireActual('@console/shared/src/components/error/error-boundary'),
...
jest.mock('@console/shared/src/components/actions', () => ({
  ...(jest as any).requireActual('@console/shared/src/components/actions'),
