...
jest.mock('../filters/FilterProvider', () => {
  ...
  return {
    ...
    FilterProvider: ({ children }) =>
      React.createElement('div', { 'data-testid': 'filter-provider' }, children),
  };
});
...
jest.mock('@console/dev-console/src/components/NamespacedPage', () => {
  ...
  return {
    __esModule: true,
    default: (props) =>
      React.createElement('div', { 'data-testid': 'namespaced-page', ...props }, props.children),
...
jest.mock('@console/internal/components/start-guide', () => {
  ...
  return {
    __esModule: true,
    withStartGuide: (Component) => (props) =>
      React.createElement(
        'div',
        { 'data-testid': 'page-contents-with-start-guide' },
