export const topologyPO = {
  ...
  sidePane: {
    ...
    title: '[data-test="topology-sidepane"] h1',
    ...
    resourcesTab: {
      startLastRun: '[data-test="topology-sidepane"] li.pipeline-overview div button',
  ...
  quickSearchPO: {
    ...
    NETSample: '[data-test="item-name-.NET SDK-Builder Images"]',
