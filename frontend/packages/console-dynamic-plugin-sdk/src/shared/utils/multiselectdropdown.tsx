  ...
  return (
    <div>
      <Select
        ...
        aria-label={t('console-dynamic-plugin-sdk~Select input')}
        onToggle={setOpen}
        onSelect={onSelect}
        selections={selected}
        isOpen={isOpen}
        placeholderText={placeholder || t('console-dynamic-plugin-sdk~Select options')}
        aria-labelledby={id}
        noResultsFoundText={t('console-dynamic-plugin-sdk~No results found')}
      >
        {items}
      </Select>
    </div>
