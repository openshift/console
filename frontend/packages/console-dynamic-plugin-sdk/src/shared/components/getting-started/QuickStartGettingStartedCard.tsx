    ...
    <QuickStartsLoader>
      {(quickStarts, loaded) => {
        ...
        const moreLink: GettingStartedLink = {
          id: 'all-quick-starts',
          title: t('console-dynamic-plugin-sdk~View all quick starts'),
          href: '/quickstart',
        };
        ...
        return (
          <GettingStartedCard
            ...
            title={t('console-dynamic-plugin-sdk~Build with guided documentation')}
            titleColor={'var(--pf-global--palette--purple-700)'}
            description={t(
              'console-dynamic-plugin-sdk~Follow guided documentation to build applications and familiarize yourself with key features.',
            )}
            links={links}
            moreLink={moreLink}
          />
