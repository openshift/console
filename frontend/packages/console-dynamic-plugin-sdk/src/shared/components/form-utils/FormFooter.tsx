      ...
      >
        {showAlert && (
          <Alert
            ...
            className="co-alert"
            variant="info"
            title={infoTitle || t('console-dynamic-plugin-sdk~You made changes to this page.')}
          >
            {infoMessage ||
              t(
                'console-dynamic-plugin-sdk~Click {{submit}} to save changes or {{reset}} to cancel changes.',
                {
                  submit: submitLabel,
                  reset: resetLabel,
                },
        ...
        <ActionGroup className="pf-c-form pf-c-form__group--no-top-margin">
          {!hideSubmit && (
            ...
            >
              {submitLabel || t('console-dynamic-plugin-sdk~Save')}
            </Button>
          )}
          {handleReset && (
            <Button
              ...
              onClick={handleReset}
            >
              {resetLabel || t('console-dynamic-plugin-sdk~Reload')}
            </Button>
          )}
          {handleCancel && (
            <Button
            ...
            >
              {cancelLabel || t('console-dynamic-plugin-sdk~Cancel')}
            </Button>
          )}
          {handleDownload && (
            <Button
              ...
              icon={<DownloadIcon />}
            >
              {t('console-dynamic-plugin-sdk~Download')}
            </Button>
          )}
        </ActionGroup>
      </ButtonBar>
