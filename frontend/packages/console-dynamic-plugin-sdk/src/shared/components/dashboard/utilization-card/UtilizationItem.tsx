    ...
    const chart = (
      <AreaChart
        ...
        ariaChartLinkLabel={t(
          'console-dynamic-plugin-sdk~View {{title}} metrics in query browser',
          {
            title,
          },
        )}
            ...
            <div className="co-utilization-card__item-section">
              ...
              >
                {humanLimit && (
                  <span>
                    {t(
                      'console-dynamic-plugin-sdk~{{humanAvailable}} available of {{humanLimit}} total limit',
                      {
                        humanAvailable,
                        humanLimit,
                      },
                ...
                {!humanLimit && humanMax && (
                  <span>
                    {t('console-dynamic-plugin-sdk~{{humanAvailable}} available of {{humanMax}}', {
                      humanAvailable,
                      humanMax,
                    })}
                  </span>
                ...
                {!humanLimit && !humanMax && (
                  <span>
                    {t('console-dynamic-plugin-sdk~{{humanAvailable}} available', {
                      humanAvailable,
                    })}
                  </span>
                )}
