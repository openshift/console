...
export const ErrorStatus: React.FC<StatusComponentProps> = (props) => {
  ...
  return (
    <GenericStatus
      ...
      title={props.title || t('console-dynamic-plugin-sdk~Error')}
    />
  );
};
...
export const InfoStatus: React.FC<StatusComponentProps> = (props) => {
  ...
  return (
    <GenericStatus
      ...
      title={props.title || t('console-dynamic-plugin-sdk~Information')}
    />
  );
};
...
export const PendingStatus: React.FC<StatusComponentProps> = (props) => {
  ...
  return (
    <GenericStatus
      ...
      title={props.title || t('console-dynamic-plugin-sdk~Pending')}
    />
  );
};
...
export const ProgressStatus: React.FC<StatusComponentProps> = (props) => {
  ...
  return (
    <GenericStatus
      {...props}
      Icon={InProgressIcon}
      title={props.title || t('console-dynamic-plugin-sdk~In progress')}
    />
  );
};
...
export const SuccessStatus: React.FC<StatusComponentProps> = (props) => {
  ...
  return (
    <GenericStatus
      ...
      title={props.title || t('console-dynamic-plugin-sdk~Healthy')}
    />
  );
};
...
export const WarningStatus: React.FC<StatusComponentProps> = (props) => {
  ...
  return (
    <GenericStatus
      ...
      title={props.title || t('console-dynamic-plugin-sdk~Warning')}
    />
  );
};
