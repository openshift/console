  ...
  if (schemaErrors.length) {
    ...
    return (
      <Alert
        ...
        variant="info"
        title={t(
          'console-dynamic-plugin-sdk~A form is not available for this resource. Please use the YAML view.',
        )}
      />
    );
  }
    ...
    <>
      {showAlert && (
        <Alert
          ...
          variant="info"
          title={t(
            'console-dynamic-plugin-sdk~Note: Some fields may not be represented in this form view. Please select "YAML view" for full control.',
          )}
        />
      )}
            ...
            <div style={{ paddingBottom: '30px' }}>
              <ActionGroup className="pf-c-form">
                <Button type="submit" variant="primary" data-test="create-dynamic-form">
                  {t('console-dynamic-plugin-sdk~Create')}
                </Button>
