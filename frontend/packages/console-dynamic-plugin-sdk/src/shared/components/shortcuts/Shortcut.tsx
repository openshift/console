      ...
      <td className="ocs-shortcut__cell">
        ...
        {hover && (
          <ShortcutCommand data-test-id="hover">
            <MouseIcon /> {t('console-dynamic-plugin-sdk~Hover')}
          </ShortcutCommand>
        )}
        {keyName && (
        ...
        {drag && (
          <ShortcutCommand data-test-id="drag">
            <MouseIcon /> {t('console-dynamic-plugin-sdk~Drag')}
          </ShortcutCommand>
        )}
        {click && (
          <ShortcutCommand data-test-id="click">
            <MouseIcon /> {t('console-dynamic-plugin-sdk~Click')}
          </ShortcutCommand>
        )}
        {rightClick && (
          <ShortcutCommand data-test-id="right-click">
            <MouseIcon /> {t('console-dynamic-plugin-sdk~Right click')}
          </ShortcutCommand>
        )}
        {dragNdrop && (
          <ShortcutCommand data-test-id="drag-and-drop">
            <MouseIcon /> {t('console-dynamic-plugin-sdk~Drag + Drop')}
          </ShortcutCommand>
        )}
      </td>
