...
import { getFieldId, useDebounceCallback } from '@console/dynamic-plugin-sdk';
          ...
          {showFilter && (
            <div className="odc-item-selector-filter">
              <TextInput
                ...
                value={filterText}
                placeholder={t('console-dynamic-plugin-sdk~Filter by type...')}
                aria-label={t('console-dynamic-plugin-sdk~Filter by type')}
              />
              {showCount && (
                <span className="odc-item-selector-filter__count">
                  {t('console-dynamic-plugin-sdk~{{count}} item', { count: itemCount })}
                </span>
              )}
            </div>
          )}
