          ...
          <Bullseye>
            <div>
              <Button
                type="button"
                variant="plain"
                aria-label={t('console-dynamic-plugin-sdk~Increase the Pod count')}
                title={t('console-dynamic-plugin-sdk~Increase the Pod count')}
              ...
              <Button
                type="button"
                variant="plain"
                aria-label={t('console-dynamic-plugin-sdk~Decrease the Pod count')}
                title={t('console-dynamic-plugin-sdk~Decrease the Pod count')}
                onClick={() => handleClick(-1)}
                isBlock
