...
Creates an HTTP headers object for use with API requests, including the CSRF token.<br/>If the user is currently impersonating another user/group, the appropriate impersonation<br/>headers will be included as well.
