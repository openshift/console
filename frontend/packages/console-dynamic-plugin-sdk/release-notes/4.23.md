...
In this release, the `ConsoleRemotePlugin` continues to reference `webpack` for type definitions where applicable. If your plugin uses only rspack, type checking for the bundler configuration might be less complete.
