...
Two long-deprecated extensions have been removed from Console.

### Removal of `console.page/resource/tab` extension

The `console.page/resource/tab` extension has been removed. This
extension was deprecated in favor of the `console.tab/horizontalNav` extension.

In your `console-extensions.json` file, replace any usage of `console.page/resource/tab`
with `console.tab/horizontalNav` using this pattern:
