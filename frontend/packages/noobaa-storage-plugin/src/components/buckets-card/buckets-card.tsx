...
import { FirehoseResource, FieldLevelHelp } from '@console/internal/components/utils';
...
const ObjectDashboardBucketsCard: React.FC<DashboardItemProps> = ({
  ...
  return (
    <DashboardCard>
      <DashboardCardHeader>
        <DashboardCardTitle>
          {t('noobaa-storage-plugin~Buckets')}
          <FieldLevelHelp>
            {t(
              'noobaa-storage-plugin~The number of buckets managed on Multicloud Object Gateway, Object bucket claims and the object bucket created as a result of object bucket claims on both Multicloud Object Gateway and RGW(if deployed).',
            )}
          </FieldLevelHelp>
        </DashboardCardTitle>
      </DashboardCardHeader>
