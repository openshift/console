    ...
    <div className="nb-create-bc-step-page">
      {showHelp && (
        ...
        >
          <p>
            {t(
              'noobaa-storage-plugin~A set of policies that would apply to all buckets(OBCs) created with the specific bucket class. These policies include: placement, namespace, caching.',
            )}
          </p>
          <ExternalLink
