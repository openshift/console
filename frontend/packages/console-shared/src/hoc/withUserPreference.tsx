...
export const withUserPreference =
  <Props extends WithUserPreferenceProps<T>, T = string>(
    key: string,
    defaultValue?: T,
    sync = false,
  ) =>
  (WrappedComponent: ComponentType<Props>): FC<Omit<Props, keyof WithUserPreferenceProps<T>>> => {
