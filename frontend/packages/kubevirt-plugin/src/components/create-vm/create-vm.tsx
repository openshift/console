...
const Footer: React.FC<FooterProps> = ({
  ...
  const isReview = activeStep.id === WIZARD_STEPS.REVIEW;
  const isCustomSource = activeStep.id === WIZARD_STEPS.SOURCE;
  const isSelectTemplate = activeStep.id === WIZARD_STEPS.TEMPLATE;
