...
import { VMPrintableStatusSimpleLabel } from '../../constants/vm-status';
import { restartVM, startVM, stopVM } from '../../k8s/requests/vm/actions';
import { pauseVMI, unpauseVMI } from '../../k8s/requests/vmi/actions';
import { startVMIMigration } from '../../k8s/requests/vmi/migration';
...
import { getMigrationVMIName } from '../../selectors/vmi-migration/vmi-migration';
import { V1alpha1DataVolume } from '../../types/api';
import { VMKind } from '../../types/vm';
import { VMImportKind } from '../../types/vm-import';
import { VMIKind } from '../../types/vmi';
import { isVMError, isVMProcessing } from '../../utils/statuses/vm-status';
import { VMStatusBundle } from '../../utils/statuses/vm/types';
import { cloneVMModal } from '../modals/clone-vm-modal/clone-vm-modal';
    ...
    const StartMessage: React.FC = () => {
      ...
      return (
        <Trans ns="kubevirt-plugin">
          <p>
            This virtual machine will start as soon as the import is complete. If you proceed, you
            will not be able to change this option.
          </p>
...
export const VmImportActionFactory = {
  Delete: (kindObj: K8sKind, vmimport: VMImportKind, innerArgs?: { vm?: VMKind }): Action => {
    const vmName = new VMImportWrapper(vmimport).getResolvedVMTargetName();
