...
import { k8sPatch } from '@console/dynamic-plugin-sdk/dist/core/lib/utils/k8s';
import {
  createModalLauncher,
  ModalBody,
  ModalComponentProps,
...
import { createBasicLookup, getLoadedData } from '../../../utils/utils';
import { ModalPendingChangesAlert } from '../../alerts/PendingChangesAlerts';
import { BootOrder } from '../../boot-order/boot-order';
