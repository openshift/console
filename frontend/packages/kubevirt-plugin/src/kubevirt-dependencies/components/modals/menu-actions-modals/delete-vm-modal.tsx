...
import { useOwnedVolumeReferencedResources } from '../../../hooks/useOwnedVolumeReferencedResources';
import { useVirtualMachineImport } from '../../../hooks/useVirtualMachineImport';
import { useUpToDateVMLikeEntity } from '../../../hooks/useVMLikeEntity';
import { deleteVM } from '../../../k8s/requests/vm/actions';
import {
...
import { getVmSnapshotVmName } from '../../../selectors/snapshots/snapshot';
import { getVolumes } from '../../../selectors/vm/selectors';
import { VMKind, VMSnapshot } from '../../../types/vm';
