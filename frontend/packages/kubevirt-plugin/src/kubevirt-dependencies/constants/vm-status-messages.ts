export const IMPORTING_VMWARE_MESSAGE =
  'The virtual machine is importing from VMware. Disks will be converted to the libvirt format.';
export const IMPORTING_ERROR_VMWARE_MESSAGE = 'The virtual machine could not be imported.';
export const IMPORTING_CDI_MESSAGE =
  'The virtual machine is importing with CDI. Disks are being copied from the source image.';
