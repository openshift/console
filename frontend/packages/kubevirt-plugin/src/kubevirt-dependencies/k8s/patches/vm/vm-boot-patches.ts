...
import { getAnnotations } from '../../../selectors/k8sCommon';
import { getBootDeviceIndex } from '../../../selectors/vm/devices';
import { getDisks, getInterfaces } from '../../../selectors/vm/selectors';
