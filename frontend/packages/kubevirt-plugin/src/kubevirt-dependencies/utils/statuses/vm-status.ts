...
import { VMPrintableStatusSimpleLabel, VMStatus } from '../../constants/vm-status';
import {
...
} from '../../constants/vm-status-messages';
...
import { findVMIMigration } from '../../selectors/vmi-migration/combined';
import { getMigrationStatusPhase, isMigrating } from '../../selectors/vmi-migration/vmi-migration';
import { getPodStatus } from '../../statuses/pod/pod';
...
const isV2VVMWareConversion = (vm: VMKind, pods?: PodKind[]): VMStatusBundle => {
  ...
  if (conversionPod && podPhase !== POD_PHASE_SUCCEEDED) {
