import { ValidationErrorType, ValidationObject } from '../../../selectors/types';
import { UIValidation, UIValidationType } from '../../../types/ui/ui';
import { validateDNS1123SubdomainValue } from '../../utils';
...
export const validateVmLikeEntityName = (
  ...
  const dnsValidation = validateDNS1123SubdomainValue(
    value,
    {
      ...
      errorMsg: 'kubevirt-plugin~VM name can contain only alphanumeric characters',
