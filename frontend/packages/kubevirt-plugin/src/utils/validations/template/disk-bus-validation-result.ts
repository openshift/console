import { asValidationObject, joinGrammaticallyListOfItems } from '@console/dynamic-plugin-sdk';
import {
  ValidationErrorType,
  ValidationObject,
} from '@console/dynamic-plugin-sdk/src/shared/utils/validation/types';
