...
export const IMPORTING_ERROR_VMWARE_MESSAGE =
  'The virtual machine could not be imported from VMware.';
export const IMPORTING_OVIRT_MESSAGE =
  'The virtual machine is being imported from Red Hat Virtualization.';
export const IMPORTING_ERROR_OVIRT_MESSAGE =
