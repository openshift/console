...
const HOST_STATUS_DEPROVISIONED = 'deprovisioned';
const HOST_STATUS_REGISTERING = 'registering';
const HOST_STATUS_INSPECTING = 'inspecting';
const HOST_STATUS_PROVISIONING = 'provisioning';
export const HOST_STATUS_DEPROVISIONING = 'deprovisioning';
const HOST_STATUS_MATCH_PROFILE = 'match profile';
const HOST_STATUS_REGISTRATION_ERROR = 'registration error';
const HOST_STATUS_INSPECTION_ERROR = 'inspection error';
const HOST_STATUS_PROVISIONING_ERROR = 'provisioning error';
const HOST_STATUS_POWER_MANAGEMENT_ERROR = 'power management error';
const HOST_STATUS_DELETING = 'deleting';
