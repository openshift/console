...
import { knativeServiceObj } from '../../components/topology/__tests__/topology-knative-test-data';
import { sampleDeployments } from '../../components/topology/__tests__/topology-test-data';
