...
import { expandPVCModal } from '@console/internal/components/modals';
...
import { useClonePVCModal } from '../../components/modals/clone/clone-pvc-modal';
...
export const usePVCActions = (
  ...
  const clonePVCModalLauncher = useClonePVCModal({
    resource: obj,
  });
