 ...
 *
 * @param {K8sKind} kindObj - The K8s model for the pod controller resource.
 ...
 *
 * @example
 * // Getting all PDB actions for a deployment
 * const MyDeploymentComponent = ({ kindObj, resource }) => {
 *   const [actions] = usePDBActions(kindObj, resource);
