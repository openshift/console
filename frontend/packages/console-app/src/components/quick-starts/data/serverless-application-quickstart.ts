...
Do you see the completed application and build?`,
          taskHelp: `This task isn’t verified yet. You might have missed a step! Try the task again, or [read more](https://docs.openshift.com/container-platform/4.5/serverless/serving-creating-managing-apps.html#creating-serverless-applications-using-the-openshift-container-platform-web-console) about this topic.`,
        },
        recapitulation: {
...
Do you see a PingSource connected by a gray line to the side of your application?`,
          taskHelp: `This task isn’t verified yet. You might have missed a step! Try the task again, or [read more](https://docs.openshift.com/container-platform/4.5/serverless/event_sources/knative-event-sources.html) about this topic.`,
        },
        recapitulation: {
...
Do you see two revisions in your Knative Service?`,
          taskHelp: `This task isn’t verified yet. You might have missed a step! Try the task again, or [read more](https://docs.openshift.com/container-platform/4.5/serverless/knative_serving/splitting-traffic-between-revisions.html) about this topic.`,
        },
        recapitulation: {
...
Has the Sample Serverless App been removed?`,
          taskHelp: `This task is not verified yet. You might have missed a step! Try the task again, or [read more](https://docs.openshift.com/container-platform/4.5/applications/application_life_cycle_management/odc-deleting-applications.html) about this topic.`,
        },
        recapitulation: {
