...
export const getGuidedTour = (): TourDataType => ({
  intro: {
    ...
    // t('console-app~Our new update with OpenShift 4.19 gives a more modern look to help enhance your experience and streamline your workflow, shuch as improved navigation and infrastructure. Want us to show your around?')
    content:
      '%console-app~Our new update with OpenShift 4.19 gives a more modern look to help enhance your experience and streamline your workflow, shuch as improved navigation and infrastructure. Want us to show your around?%',
  },
  steps: [
    {
      placement: 'right',
