...
export const getClusterConfigurationGroups = (
  ...
  const initialClusterConfigurationGroup: ClusterConfigurationTabGroup[] =
    clusterConfigurationGroups.map((clusterConfigurationGroup) => ({
      ...clusterConfigurationGroup,
      items: [],
    }));
  const populatedClusterConfigurationGroup: ClusterConfigurationTabGroup[] =
