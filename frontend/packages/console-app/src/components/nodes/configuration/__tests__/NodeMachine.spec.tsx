...
jest.mock('@console/internal/components/machine-config-pool', () => ({
  MachineConfigPoolCharacteristics: jest.fn(() => <div>MachineConfigPool characteristics</div>),
...
describe('NodeMachine', () => {
  ...
  it('should show loading skeleton when data is loading', () => {
    ...
    const { container } = render(<NodeMachine obj={mockNode} />);
  ...
  it('should display error message when machine fails to load', () => {
    ...
    render(<NodeMachine obj={mockNode} />);
  ...
  it('should display machine details when machine is loaded', () => {
    ...
    expect(screen.getByText('Machine details for test-machine')).toBeInTheDocument();
  });
  ...
  it('should display message when machine config pool is not found', () => {
    ...
    expect(screen.getByText('Machine config pool not found')).toBeInTheDocument();
  });
  ...
  it('should display machine config pool details when loaded', () => {
    ...
    expect(screen.getByText('MachineConfigPool summary')).toBeInTheDocument();
    expect(screen.getByText('MachineConfigPool characteristics')).toBeInTheDocument();
  });
