  ...
  return (
    <>
      <PaneBody>
        ...
        <Content component="p">
          {t(
            'console-app~This section shows how the node is provisioned and configured—from the underlying machine, OS, and hardware details to the system-level configurations applied. It helps you understand both where the node comes from and how it’s set up to run workloads.',
          )}
        </Content>
      </PaneBody>
      <PaneBody>
