...
const mockDedupeRemediationTemplateRefs = jest.fn();
const mockComputeRemediationTimeBoundsFromRefs = jest.fn();

jest.mock('../../../utils/estimatedRecoveryRemediation', () => ({
  ...
  dedupeRemediationTemplateRefs: (...args: any[]) => mockDedupeRemediationTemplateRefs(...args),
  computeRemediationTimeBoundsFromRefs: (...args: any[]) =>
    mockComputeRemediationTimeBoundsFromRefs(...args),
...
// Mock utils module
const mockGetMaxTimeoutFromConditions = jest.fn();
const mockFormatTimeoutForDisplay = jest.fn();

jest.mock('../../../utils/utils', () => ({
  getMaxTimeoutFromConditions: (...args: any[]) => mockGetMaxTimeoutFromConditions(...args),
  formatTimeoutForDisplay: (...args: any[]) => mockFormatTimeoutForDisplay(...args),
}));
...
describe('Details', () => {
  ...
  beforeEach(() => {
    ...
    mockDedupeRemediationTemplateRefs.mockImplementation((refs) => refs);

    mockComputeRemediationTimeBoundsFromRefs.mockReturnValue({
      minSeconds: 180,
      maxSeconds: 300,
    });

    mockGetMaxTimeoutFromConditions.mockReturnValue(300);
    mockFormatTimeoutForDisplay.mockReturnValue('5m');
  });
