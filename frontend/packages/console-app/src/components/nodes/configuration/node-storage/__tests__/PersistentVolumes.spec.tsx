...
import { useAccessibleResources } from '@console/app/src/hooks/useAccessibleResources';
...
jest.mock('@console/app/src/hooks/useAccessibleResources', () => ({
...
describe('PersistentVolumes', () => {
  ...
  it('should show loading skeleton when data is loading', () => {
    ...
    expect(screen.getByTestId('persistent-volumes-table-loading')).toBeInTheDocument();
  });
  ...
  it('should display persistent volume information in a table', () => {
    useK8sWatchResourceMock.mockReturnValue([[mockPV], true, undefined]);
  ...
  it('should filter persistent volumes by node hostname label', () => {
    ...
    useK8sWatchResourceMock.mockReturnValue([[mockPV, pvOtherNode], true, undefined]);
    useAccessibleResourcesMock
      .mockReturnValueOnce([[mockPVC], true, undefined])
      .mockReturnValueOnce([[], true, undefined])
      .mockReturnValueOnce([[mockPod], true, undefined]);
  ...
  it('should handle VirtualMachine instances', () => {
    ...
    useAccessibleResourcesMock.mockImplementation((opts) => {
      switch (opts?.groupVersionKind?.kind) {
        case 'PersistentVolumeClaim':
          return [[pvcWithDV], true, undefined];
        case 'DataVolume':
          return [[dataVolume], true, undefined];
        case 'Pod':
          return [[mockPod], true, undefined];
        default:
