...
describe('UserPreferenceDropdownField', () => {
  ...
  it('should render skeleton when user preferences are loading', async () => {
    ...
    expect(screen.getByTestId('select skeleton test-dropdown-field')).toBeInTheDocument();
  });

  it('should render dropdown with correct selected option when user preference is loaded', async () => {
    setupMocks('option1');
  ...
  it('should set default value when user preference is loaded but empty', async () => {
