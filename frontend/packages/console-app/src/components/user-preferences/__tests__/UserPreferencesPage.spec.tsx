...
describe('UserPreferencePage', () => {
  ...
  it('should render with "general" user preference group as default if url params does not provide a group', async () => {
    jest.spyOn(Router, 'useParams').mockReturnValue({});
    useExtensionsMock.mockReturnValue(mockUserPreferenceGroupExtensions);
    useResolvedExtensionsMock.mockReturnValue([mockUserPreferenceItemExtensions, true]);
    useQueryParamsMock.mockReturnValue(new URLSearchParams());
  ...
  it('should render loading state if user preference extensions have not resolved', async () => {
    jest.spyOn(Router, 'useParams').mockReturnValue({});
    useExtensionsMock.mockReturnValue(mockUserPreferenceGroupExtensions);
    ...
    expect(screen.queryByRole('tab', { name: /language/i })).not.toBeInTheDocument();
  });
});
