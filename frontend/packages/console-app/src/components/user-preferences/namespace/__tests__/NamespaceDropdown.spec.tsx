...
describe('NamespaceDropdown', () => {
  ...
  it('should render skeleton when user preferences are loading', async () => {
    ...
    expect(screen.getByTestId('dropdown skeleton console.preferredNamespace')).toBeVisible();
  });

  it('should display preferred namespace when set', async () => {
  ...
  it('should display "Last viewed" when no preferred namespace is set', async () => {
