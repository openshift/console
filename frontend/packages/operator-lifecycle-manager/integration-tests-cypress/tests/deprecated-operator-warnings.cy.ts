...
describe('Deprecated operator warnings', () => {
  ...
  it('verify deprecated operator warnings in the OperatorHub details panel', () => {
    cy.visit(
      `/catalog/ns/${testName}?type=operator&keyword=kia&selectedId=kiali-test-community-operator-deprecation-openshift-marketplace&channel=stable&version=1.83.0`,
    );
