...
import { navigateImportFromGit, setBuilderImage, enterGitRepoUrl, addApplication, applicationName, appName, builderImage, buildImageVersion } from '../../views/devconsole-view/git-imort-flow';
...
describe ('git import flow' , () => {
  ...
  const createButton = $('.pf-c-button.pf-m-primary');
