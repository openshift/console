...
const PKGS_TO_CHECK: Array<{ name: string; semver: string }> = [
  { name: '@patternfly-4/patternfly', semver: '4.x' },
  { name: '@patternfly-4/quickstarts', semver: '2.x' },
  { name: '@patternfly-4/react-catalog-view-extension', semver: '4.x' },
  { name: '@patternfly-4/react-core', semver: '4.x' },
  { name: '@patternfly-4/react-icons', semver: '4.x' },
  { name: '@patternfly-4/react-styles', semver: '4.x' },
  { name: '@patternfly-4/react-table', semver: '4.x' },
  { name: '@patternfly-4/react-tokens', semver: '4.x' },
  { name: '@patternfly/patternfly', semver: '5.x' },
  { name: '@patternfly/quickstarts', semver: '5.x' },
  { name: '@patternfly/react-catalog-view-extension', semver: '5.x' },
  { name: '@patternfly/react-charts', semver: '7.x' },
  { name: '@patternfly/react-component-groups', semver: '5.x' },
  { name: '@patternfly/react-console', semver: '5.x' },
  { name: '@patternfly/react-core', semver: '5.x' },
  { name: '@patternfly/react-icons', semver: '5.x' },
  { name: '@patternfly/react-log-viewer', semver: '5.x' },
  { name: '@patternfly/react-styles', semver: '5.x' },
  { name: '@patternfly/react-table', semver: '5.x' },
  { name: '@patternfly/react-templates', semver: '1.x' },
  { name: '@patternfly/react-tokens', semver: '5.x' },
  { name: '@patternfly/react-topology', semver: '5.x' },
  { name: '@patternfly/react-user-feedback', semver: '5.x' },
  { name: '@patternfly/react-virtualized-extension', semver: '5.x' },
];
