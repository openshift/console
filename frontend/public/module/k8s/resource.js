...
export const devfileCreate =  async (kind, data, opts = {}) =>  {
  ...
  if(isMock) {
    ...
    // devfileResources = getMockDevfileData(data, buildStrategyData);
    devfileResources = {
      imageStream : {
     ...
     //     data: {},
     //     kind: 'Secret',
     //     metadata: {JSON.parse(devfileResourceObjectsString.devfileResources)
...
function getMockDevfileData (data, buildStrategyData){
