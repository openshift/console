angular.module('k8s').constant('k8sEnum', {
  ...
  Kind: {
    ...
    'TCO_CLUSTERSPEC': {
      id: 'tectonicchannelcontrollerclusterspec',
      kind: 'TectonicChannelControllerClusterSpec',
      label: 'TectonicChannelControllerClusterSpec',
      labelPlural: 'TectonicChannelControllerClusterSpecs',
      basePath: '/apis/tectonic-channel-controller.tectonic.com/',
      apiVersion: 'v1',
      path: 'tectonicchannelcontrollerclusterspecs',
      plural: 'tectonicchannelcontrollerclusterspecs',
    },
    'TCO_CONFIG': {
      id: 'tectonicchannelcontrollerconfig',
      kind: 'TectonicChannelControllerConfig',
      label: 'TectonicChannelControllerConfig',
      labelPlural: 'TectonicChannelControllerConfigs',
      basePath: '/apis/tectonic-channel-controller.tectonic.com/',
      apiVersion: 'v1',
      path: 'tectonicchannelcontrollerconfigs',
      plural: 'tectonicchannelcontrollerconfigs',
    },
    'TECTONICVERSIONUPDATE': {
      id: 'tectonicversionupdate',
      kind: 'TectonicVersionUpdate',
      label: 'TectonicVersionUpdate',
      labelPlural: 'TectonicVersionUpdates',
      basePath: '/apis/tectonic-version.tectonic.com/',
      apiVersion: 'v1',
      path: 'tectonicversionupdates',
      plural: 'tectonicversionupdates',
    },
    PETSET: {
      id: 'petset',
      label: 'Petset',
