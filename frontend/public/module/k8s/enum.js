angular.module('k8s').constant('k8sEnum', {
  ...
  Kind: {
    ...
    'TCO_CLUSTERSPEC': {
      id: 'tectonicchanneloperatorclusterspec',
      kind: 'TectonicChannelOperatorClusterSpec',
      label: 'TectonicChannelOperatorClusterSpec',
      labelPlural: 'TectonicChannelOperatorClusterSpecs',
      basePath: '/apis/tectonic-channel-operator.tectonic.com/',
      apiVersion: 'v1',
      path: 'tectonicchanneloperatorclusterspecs',
      plural: 'tectonicchanneloperatorclusterspecs',
    },
    'TCO_CONFIG': {
      id: 'tectonicchanneloperatorconfig',
      kind: 'TectonicChannelOperatorConfig',
      label: 'TectonicChannelOperatorConfig',
      labelPlural: 'TectonicChannelOperatorConfigs',
      basePath: '/apis/tectonic-channel-operator.tectonic.com/',
      apiVersion: 'v1',
      path: 'tectonicchanneloperatorconfigs',
      plural: 'tectonicchanneloperatorconfigs',
    },
