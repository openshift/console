...
export const k8sGet = (kind: K8sKind, name: string, ns?: string, opts?: Object) =>
  coFetchJSON(resourceURL(kind, Object.assign({ ns, name }, opts)));

export const k8sCreate = <R extends K8sResourceCommon>(kind: K8sKind, data: R, opts = {}) => {
...
export const k8sKillByName = <R extends K8sResourceCommon>(
  ...
  namespace?: string,
  opts: Options = {},
): Promise<R> => k8sKill(kind, { metadata: { name, namespace } }, opts);
