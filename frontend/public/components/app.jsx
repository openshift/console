            ...
            <div id="content">
              ...
              <div id="content-scrollable">
                <Switch>
                  ...
                  <LazyRoute path="/cluster-overview" exact loader={() => import('../kubevirt/components/cluster/cluster-overview' /* webpackChunkName: "kubevirt-cluster-overview" */).then(m => m.ClusterOverview)} />
