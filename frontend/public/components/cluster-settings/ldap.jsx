...
const STATES = {'untested': 1, 'invalid': 2, 'valid': 3, 'updating': 4, 'somefuckingstate': 5};

const Code = ({children}) => <span className="ldap-code">{children}</span>;
  ...
  render () {
    ...
    return <form className="form-horizontal" style={{maxWidth: 900}}>
      ...
      {stateMachine === STATES.updating && <div>
        ...
        <pre className="ldap-pre"><Code>kubectl apply -f ~/Downloads/new-tectonic-config.yaml</Code></pre>
