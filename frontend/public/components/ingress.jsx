...
import {Cog, LabelList, navFactory, ResourceIcon, Timestamp, detailsPage, EmptyBox, ResourceLink} from './utils';
...
const pages = [{href: 'details', name: 'Overview', component: detailsPage(Details)}, editYaml()];
