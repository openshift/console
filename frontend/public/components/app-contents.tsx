  ...
  <PageSection variant={PageSectionVariants.light}>
    ...
    <Switch>
      ...
      <LazyRoute
        ...
        exact
        loader={() =>
          import('./service-catalog/create-binding' /* webpackChunkName: "create-binding" */).then(
      ...
      <LazyRoute
        ...
        exact
        loader={() =>
          import('./monitoring' /* webpackChunkName: "monitoring" */).then((m) => m.MonitoringUI)
        }
      />
      <LazyRoute
      ...
      <LazyRoute
        loader={() => import('./error' /* webpackChunkName: "error" */).then((m) => m.ErrorPage404)}
      />
    </Switch>
  </PageSection>
);
