        ...
        <div id="content-scrollable">
          <Switch>
            ...
            <LazyRoute
              ...
              loader={() =>
                import(
                  './operator-hub/operator-hub-page' /* webpackChunkName: "operator-hub" */
                ).then((m) => m.OperatorHubPage)
              }
            />
            <LazyRoute
            ...
            <LazyRoute
              ...
              loader={() =>
                import(
                  './operator-hub/operator-hub-subscribe' /* webpackChunkName: "operator-hub-subscribe" */
                ).then((m) => m.OperatorHubSubscribePage)
              }
            />
            ...
            <LazyRoute
              path="/operatormanagement/all-namespaces"
              loader={() =>
                import('./operator-management' /* webpackChunkName: "operator-management" */).then(
                  (m) => m.OperatorManagementPage,
                )
              }
            />
            <LazyRoute
              path="/operatormanagement/ns/:ns"
              loader={() =>
                import('./operator-management' /* webpackChunkName: "operator-management" */).then(
                  (m) => m.OperatorManagementPage,
                )
            ...
            <LazyRoute
              ...
              loader={() =>
                import(
                  './operator-lifecycle-manager' /* webpackChunkName: "create-subscription-yaml" */
                ).then((m) => NamespaceFromURL(m.CreateSubscriptionYAML))
              }
            />
            ...
            <LazyRoute
              path={`/k8s/ns/:ns/${ClusterServiceVersionModel.plural}/:name/edit`}
              exact
              loader={() =>
            ...
            />
            <LazyRoute
              path={`/k8s/ns/:ns/${ClusterServiceVersionModel.plural}/:appName/:plural/~new`}
              exact
              loader={() =>
                import(
                  './operator-lifecycle-manager/create-operand' /* webpackChunkName: "create-operand" */
                ).then((m) => m.CreateOperandPage)
              }
            />
            <Route
            ...
            <LazyRoute
              path="/deploy-image"
              exact
              loader={() => import('./deploy-image').then((m) => m.DeployImage)}
            />
