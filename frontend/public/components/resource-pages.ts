...
export const resourceListPages = ImmutableMap<GroupVersionKind | string, () => Promise<React.ComponentType<any>>>()
  ...
  .set(referenceForModel(VmTemplateModel), () => import('../kubevirt/components/vm-template/vm-template' /* webpackChunkName: "vm-templates" */).then(m => m.VirtualMachineTemplatesPage))
