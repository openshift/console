...
export const resourceDetailPages = ImmutableMap<GroupVersionKind | string, () => Promise<React.ComponentType<any>>>()
  ...
  .set(referenceForModel(VmTemplateModel), () => import('../kubevirt/components/vm-template/vm-template-detail' /* webpackChunkName: "vm-templates" */).then(m => m.VirtualMachineTemplateDetailsPage))
...
export const resourceListPages = ImmutableMap<GroupVersionKind | string, () => Promise<React.ComponentType<any>>>()
  ...
  .set(referenceForModel(VirtualMachineModel), () => import('../kubevirt/components/vm/vm' /* webpackChunkName: "virtual-machines" */).then(m => m.VirtualMachinesPage))
