    ...
    <PaneBodyGroup>
      <DescriptionList className="co-detail-table">
        <Card>
          ...
          <DescriptionListDescription>{`${desiredReplicas}  ${t('public~machines', {
        ...
        <Card>
          ...
          <DescriptionListDescription>
            <Tooltip
              content={t(
                'public~The number of uanavailable replicas for this MachiControlPlaneMachineSetneSet.',
              )}
            >
              {unavailableReplicas ? (
                <span>
...
const ControlPlaneMachineSetList: React.FC = (props) => {
  const { t } = useTranslation();

  const ControlPlaneMachineSetTableHeader = () => {
    return [
      {
        title: t('public~Name'),
  ...
  const ControlPlaneMachineSetTableRow: React.FC<RowFunctionArgs<ControlPlaneMachineSetKind>> = ({
    obj,
  }) => {
  ...
  return (
    <>
      <Table
        ...
        Header={ControlPlaneMachineSetTableHeader}
