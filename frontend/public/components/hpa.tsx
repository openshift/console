  ...
  return data.map(({ obj }) => {
    ...
    const rowCells = {
      [tableColumnInfo[0].id]: {
        cell: (
          <ResourceLink
            groupVersionKind={getGroupVersionKindForModel(HorizontalPodAutoscalerModel)}
            name={name}
            namespace={namespace}
          />
        ),
      ...
      [tableColumnInfo[2].id]: {
        cell: <LabelList kind={HorizontalPodAutoscalersReference} labels={obj.metadata.labels} />,
      },
