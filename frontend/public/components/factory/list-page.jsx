...
import { DropdownFilter } from '../row-filters';
...
/** @augments {React.PureComponent<{ListComponent: React.ComponentType<any>, kinds: string[], filters?:any, flatten?: function, data?: any[], rowFilters?: any[], showNameFilter?: boolean, showLabelFilter?: boolean }>} */
