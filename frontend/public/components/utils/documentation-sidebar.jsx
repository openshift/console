...
export const DocumentationSidebar = () => <div className="co-p-cluster__sidebar">
  <div className="co-m-pane__body">
    ...
    <p><a href="/start-guide" className="co-p-cluster__sidebar-link"><span className="fa fa-fw fa-info-circle co-p-cluster__sidebar-link-icon"></span>Quick Start Guide</a></p>
    <p><a href="https://coreos.com/tectonic/docs/latest/" target="_blank" className="co-p-cluster__sidebar-link"><span className="fa fa-fw fa-book co-p-cluster__sidebar-link-icon"></span>Full Documentation</a></p>
    <p><a href="https://github.com/coreos/tectonic-forum" target="_blank" className="co-p-cluster__sidebar-link"><span className="fa fa-fw fa-comments-o co-p-cluster__sidebar-link-icon"></span>Tectonic Forum</a></p>
