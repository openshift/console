      ...
      <p>
        ...
        <span className="co-modal-ignore-warning__link">
          {RH_OPERATOR_SUPPORT_POLICY_LINK && (
            <a href={RH_OPERATOR_SUPPORT_POLICY_LINK} target="_blank" className="co-external-link" rel="noopener noreferrer">Learn more about Red Hat’s third party software support policy</a>
          )}
        </span>
