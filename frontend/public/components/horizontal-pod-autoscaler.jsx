...
import {Cog, LabelList, LoadingInline, ResourceLink, Timestamp, navFactory} from './utils';
...
const pages = [{href: 'details', name: 'Overview', component: Details}, navFactory.editYaml()];
