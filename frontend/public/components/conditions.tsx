      ...
      {conditions?.length ? (
        <div className="co-m-table-grid co-m-table-grid--bordered">
          <div className="row co-m-table-grid__head">
            <div className="col-xs-4 col-sm-2 col-md-2">{t('workload~Type')}</div>
            <div className="col-xs-4 col-sm-2 col-md-2">{t('workload~Status')}</div>
            <div className="hidden-xs hidden-sm col-md-2">{t('workload~Updated')}</div>
            <div className="col-xs-4 col-sm-3 col-md-2">{t('workload~Reason')}</div>
            <div className="hidden-xs col-sm-5 col-md-4">{t('workload~Message')}</div>
          </div>
          <div className="co-m-table-grid__body">{rows}</div>
        </div>
      ) : (
        <div className="cos-status-box">
          <div className="text-center">{t('workload~No conditions found')}</div>
        </div>
      )}
    </>
  );
