...
import {Cog, LabelList, ResourceLink, Timestamp, navFactory} from './utils';
...
const pages = [{href: 'details', name: 'Overview', component: ConfigMapDetails}, navFactory.editYaml()];
