...
const StorageClassFormWithTranslation = withTranslation()(
  ...
  > {
    ...
    getExtensions = (extensions) => {
      extensions.forEach((ext: ResolvedStorageClassProvisioner) => {
        if (isCSIProvisionerExtension(ext)) {
          ...
          this.defaultStorageTypes[ext.properties.OTHERS.provisioner] = {
    ...
    getProvisionerElements = () => {
        ...
        return (
          <div
            ...
            className={classNames('form-group', {
              'has-error': _.get(
                this.state.newStorageClass.parameters,
                `${key}.validationMsg`,
                null,
              ),
            })}
      ...
      const { t } = this.props;
      const documentationLink = this.storageTypes[this.state.newStorageClass.type]
        ?.documentationLink;
      return (
        <>
                ...
                <div className="checkbox">
                  <label>
                    <input
                      ...
                      className="create-storage-class-form__checkbox"
                      onChange={(event) =>
                        this.setStorageHandler('expansion', event.target.checked)
                      }
