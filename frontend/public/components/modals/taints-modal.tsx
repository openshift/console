...
class TaintsModal extends PromiseComponent {
  ...
  _addRow = () => {
    this.setState((prevState: TaintsModalState) => ({
      taints: [...prevState.taints, {key: '', value: '', effect: ''}],
    }));
  };
        ...
        {_.map(this.state.taints, (c, i) =>
          <div className="row">
            <div className="col-md-4 col-sm-6 col-xs-6 taint-modal__field">
              ...
              <input type="text" className="form-control" value={c.key} onChange={(e) => this._change(e, i, 'key')} />
            </div>
            ...
            <div className="col-md-1 col-md-offset-0 col-sm-offset-11 col-xs-offset-11">
              <button type="button" className="btn btn-link taint-modal__delete-icon" onClick={() => this._remove(i)}>
