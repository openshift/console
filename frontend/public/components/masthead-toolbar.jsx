      ...
      <>
        <PageHeaderTools>
          ...
          <PageHeaderToolsGroup>
            ...
            <PageHeaderToolsItem className="visible-xs-block">{this._renderMenu(true)}</PageHeaderToolsItem>
            {/* desktop -- (user dropdown [logout]) */}
            <PageHeaderToolsItem className="hidden-xs">{this._renderMenu(false)}</PageHeaderToolsItem>
          </PageHeaderToolsGroup>
        </PageHeaderTools>
