...
export const PollConsoleUpdates = memo(() => {
  ...
  const prevPluginManifestsData = prevPluginManifestsDataRef.current; // eslint-disable-line react-hooks/refs -- usePrevious pattern: reading previous render's value
