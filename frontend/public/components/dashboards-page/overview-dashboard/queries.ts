...
const overviewQueries = {
  ...
  [OverviewQuery.PODS_BY_STORAGE]: 'sort_desc(avg by (pod_name)(irate(container_fs_io_time_seconds_total{container_name="POD", pod_name!=""}[1m])))',
  [OverviewQuery.PODS_BY_NETWORK]: `sort_desc(sum by (pod_name)(irate(container_network_receive_bytes_total{container_name="POD", pod_name!=""}[1m]) + 
