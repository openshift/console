...
export const BuildConfigsDetails: Snail.FCC<BuildConfigsDetailsProps> = ({ obj: buildConfig }) => {
...
export const BuildConfigsList: Snail.FCC<BuildConfigsListProps> = ({ data, loaded, ...props }) => {
