...
export const ClusterServiceVersionResourcesPage = connect(inFlightStateToProps)(
  (props: ClusterServiceVersionResourcesPageProps) => {
    ...
    const createLink = (name: string) => `/k8s/ns/${obj.metadata.namespace}/${ClusterServiceVersionModel.plural}/${obj.metadata.name}/${referenceForCRDDesc(_.find(owned, {name}))}/_new`;
