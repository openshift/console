...
const config: Configuration = {
  ...
  resolve: {
    ...
    alias: {
      ...
      'frontend/packages/console-app/src/components/dashboards-page/dynamic-plugins-health-resource':
        'frontend/packages/console-app/src/components/dashboards-page/dynamic-plugins-health-resource/index.ts',
      ...overpassFiles,
    },
  },
  node: {
    ...
    splitChunks: {
      ...
      cacheGroups: {
        vendors: {
          ...
          priority: -10,
          enforce: true,
          filename: 'vendors~[name]-bundle-[contenthash].min.js',
        },
        'vendor-patternfly-5': {
