...
export interface ConsoleExtensionsI18nextCLIPluginOptions {
  /**
   * Paths to `console-extensions.json` files, assumed to be encoded as UTF-8.
   *
   * Defaults to a single `console-extensions.json` file in the current working directory.
   */
  paths?: string[];
}
