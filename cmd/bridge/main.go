...
const (
	...
	// TODO: url 입력
	hypercloudServerHost = "hypercloud5-api-server-service.hypercloud5-system.svc:28678"

	// Well-known location of hypercloud-server for hypercloud. This is only accessible in-clsuter. // http port : 80 don't require
	multiHypercloudServerHost = "hypercloud-multi-api-server-svc.hypercloud5-system.svc"
)
