...
4. **DRY Helpers** - Extract repetitive setup into reusable functions
...
**IMPORTANT: Follow this fully automated workflow:**
...
### 3. Iterative Test Execution (Fully Autonomous)

**MANDATORY: Follow this step-by-step workflow and track progress internally:**
...
- After validating ES6 imports, **IMMEDIATELY** run tests using:
  ...
  ```
- Capture full test output including all failures and warnings
...
- ✅ **Step 1 Complete:** Tests executed at least once
- ✅ **Step 2 Complete:** All test failures resolved
- ✅ **Step 3 Complete:** Tests must have 100% pass rate
