...
type HelmRequest struct {
	...
	BasicAuthSecretName string                 `json:"basic_auth_secret_name"` // optional; names a Secret in Namespace with keys username and password for OCI/HTTP chart pull when NoRepo is true.
}
